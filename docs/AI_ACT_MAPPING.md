...
| C4 | LLM-as-judge automation | **Art. 15** §3 (verificabilità) | Allegato IV §3 | Protocollo automatico e ripetibile di valutazione di un attacco; prerequisito perché una mitigazione sia *misurabile* |
| C4 | Defense-design + delta pre/post | **Art. 9.2.d** (misure di mitigazione) | Allegato IV §2.g | Misurazione pre/post di una mitigazione tecnica: il *delta* è l'evidenza che la mitigazione produce l'effetto dichiarato |
